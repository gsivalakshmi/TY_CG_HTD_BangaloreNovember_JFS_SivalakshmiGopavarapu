package com.cg.employeespringmvc.controller;
...
import com.cg.employeespringmvc.service.EmployeeService;
...
public class EmployeeController {
	...
	public String register(EmployeeBean bean,ModelMap map) {
		...
		if(check) {
			map.addAttribute("msg","u have register to the employee portal");
		}else {
			map.addAttribute("msg","Sorry!!...This Email already Exists...");
		}
		return "login";
	}
	@GetMapping("/search")
	...
	public String changePassword(String password,@SessionAttribute("bean")
	EmployeeBean bean) {
